...
public class MyCommentDto {
    ...
    @Builder
    public MyCommentDto(Integer id, Integer authorId, Integer postId, Boolean isDeleted, String boardType,
                        String boardAlias, String postTitle, String body, LocalDateTime createdAt, Boolean isMine) {
        this.id = id;
