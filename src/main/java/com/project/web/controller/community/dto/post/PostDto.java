...
public class PostDto {
    ...
    public PostDto(Integer id, Integer authorId, Boolean isNotice, Boolean isHot, LocalDateTime createdAt,
                   String category, String boardType, String authorNickname, String authorProfileImage, String title,
                   String body, LocalDateTime updatedAt, Integer hitCount, Integer recommendCount, Integer commentCount,
                   Integer totalCommentCount, Boolean isMine) {
        this.id = id;
