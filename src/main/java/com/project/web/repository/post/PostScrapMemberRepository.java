...
import com.project.web.domain.post.PostScrapMember;
...
public interface PostScrapMemberRepository extends JpaRepository<PostScrapMember, Integer> {
    ...
    */
    @Query(nativeQuery = true,
            value = "select p.id, psm.member_id, p.created_at, b.type, b.alias, pc.title " +
                    "from (select tp.id from post_scrap_member tp where tp.member_id = :memberId order by tp.scrap_at desc limit :limit offset :offset) as temp " +
